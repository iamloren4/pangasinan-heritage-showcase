  ...
  return <>
    ...
    <main>
      <section className="relative isolate min-h-[620px] overflow-hidden bg-sea-900 text-white sm:min-h-[710px]">
        <Image src={`${basePath}/heritage/sunset.jpg`} alt="Pangasinan coastline at sunset" fill priority sizes="100vw" className="-z-20 object-cover object-right" />
